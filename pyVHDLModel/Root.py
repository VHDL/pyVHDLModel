...
from pyVHDLModel               import ModelEntity, DesignUnitKind, DependencyGraphVertexKind, DependencyGraphEdgeKind, NamedEntityMixin, DocumentedEntityMixin
...
from pyVHDLModel.DesignUnit    import Architecture, PackageBody, Context, Entity, Configuration, Package, DesignUnit, PrimaryUnit
